...
* SVN: $Id$
*/
#ifndef LABROB_GAZEBO_CAMERA_UTILS_FUERTE_HH
#define LABROB_GAZEBO_CAMERA_UTILS_FUERTE_HH
...
namespace gazebo{
	...
	class labrob_gazebo_camera_utils{
		/// \brief Constructor
		/// \param parent The parent entity, must be a Model or a Sensor
		public: labrob_gazebo_camera_utils();
