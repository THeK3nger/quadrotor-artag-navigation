...
/// @{
/** \defgroup labrobLaserController ROS Laser Scanner Controller Plugin
...
class labrobLaserController : public Controller
{
	/// \brief Constructor
	/// \param parent The parent entity, must be a Model or a Sensor
	public: labrobLaserController(Entity *parent);

	/// \brief Destructor
	public: virtual ~labrobLaserController();
