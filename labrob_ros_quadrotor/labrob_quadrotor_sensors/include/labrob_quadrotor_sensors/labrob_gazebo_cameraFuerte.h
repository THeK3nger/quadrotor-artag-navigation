...
* SVN: $Id$
*/
#ifndef LABROB_ROS_CAMERA_HH
#define LABROB_ROS_CAMERA_HH
...
namespace gazebo{
	class labrob_gazebo_camera : public DepthCameraPlugin, labrob_gazebo_camera_utils{
		/// \brief Constructor
		/// \param parent The parent entity, must be a Model or a Sensor
		public: labrob_gazebo_camera();
		...
		using labrob_gazebo_camera_utils::PublishCameraInfo;
