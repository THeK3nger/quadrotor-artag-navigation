...
* SVN: $Id$
*/
#ifndef LABROB_GAZEBO_IMU_HH
#define LABROB_GAZEBO_IMU_HH
...
/// @{
	/** \defgroup labrob_gazebo_IMU Groud Truth Position Pose and Rates Interface

	\brief labrob_gazebo_IMU controller.
...
*/
	...
	class labrob_gazebo_IMU : public Controller{
			/// \brief Constructor
			public: labrob_gazebo_IMU(Entity *parent );
			
			/// \brief Destructor
			public: virtual ~labrob_gazebo_IMU();
			...
			/// \brief Topic name of the velocity
			private: ParamT<std::string> *topicNameVelP;
			private: std::string topicNameVel;
			private: ros::Publisher pubVel_;
			...
			private: int imuConnectCountVel;
			private: void IMUConnectVel();
			private: void IMUDisconnectVel();
